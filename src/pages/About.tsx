          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-poster-muted p-6 rounded-lg mb-8">
              ...
              <p className="mb-4">
                ...
                You can also save your favorite posters by clicking the heart icon so you can easily find them later.
              </p>
              <p>
                All favorites are saved locally to your device, so you can come back anytime to view your collection.
              </p>
            </div>
